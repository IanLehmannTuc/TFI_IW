...
public class UsuarioRepositoryPostgres implements UsuarioRepository {
    ...
    private static class UsuarioRowMapper implements RowMapper<Usuario> {
        ...
        public Usuario mapRow(@org.springframework.lang.NonNull ResultSet rs, int rowNum) throws SQLException {
            ...
            return new Usuario(email, passwordHash, autoridad, cuil, nombre, apellido, matricula);
        }
    }
    ...
    public Optional<Usuario> findByEmail(String email) {
        ...
        String sql = "SELECT email, password_hash, autoridad, cuil, nombre, apellido, matricula " +
    ...
    public List<Usuario> findAll() {
        String sql = "SELECT email, password_hash, autoridad, cuil, nombre, apellido, matricula FROM usuarios";
